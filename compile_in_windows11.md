...
# Qt6, for the optional GUI (grainmeter-gui). Skip this and cmake will
# just build the CLI alone -- it silently prints "Qt6 Widgets not found --
# skipping grainmeter-gui" in the configure output rather than erroring,
# so it's easy to miss that the GUI didn't build.
pacman -S mingw-w64-ucrt-x86_64-qt6-base
pacman -S mingw-w64-ucrt-x86_64-qt6-tools   # needed for windeployqt, used below
...
./build/gui/grainmeter-gui.exe   # if Qt6 was installed above

# package both the CLI and GUI (with all required DLLs and Qt plugins)
# into dist/, ready to zip and hand to someone without MSYS2/OpenCV/Qt
# installed on their machine.
./scripts/package_windows_msys2_dist.sh
ls dist/
# now you can zip dist/ and copy it to any windows 11 computer
```